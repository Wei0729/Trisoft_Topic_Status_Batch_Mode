        ...
        Try
            ...
            For Each topic As String In topics
                ...
                For k As Integer = 0 To perTopics.Length() - 1
                    ...
                    ElseIf k = 3 Then
                        reportResult = perTopics(k)
                    End If
                Next
                If topicGUID <> "" And topicVersion <> "" And topicType <> "" And reportResult <> "" And reportResult <> "LanguageVersionMissing" Then
                    ...
                    If topicEN <> "" Then
                        ...
                        oSheet.Cells(excelRow, 14).Value = InTranslationDate
                        oSheet.Cells(excelRow, 15).Value = TranslatedDate
